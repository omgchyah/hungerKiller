<x-main-layout>
    ...
    <div class="flex justify-around p-4 mb-4">
        ...
        <div class="w-1/2 pl-4">
            ...
            <div class="mt-2">Servings: {{ $recipe->servings }}</div>
            <div class="mt-2">Difficulty: {{ $recipe->difficulty }}</div>
            <div class="mt-2">Category: {{ $recipe->category }}</div>
            <div class="mt-2">Restrictions: {{ $recipe->restrictions }}</div>
        </div>
    </div>
    ...
    <div class="flex justify-center px-4 py-2 space-x-4 text-center">
    ...
    <div class="flex justify-around p-4 mb-16">
        ...
        <div class="w-1/2 pl-4">
            ...
            <div class="mt-2">{{ $recipe->instructions }}</div>
        </div>
    </div>
